<template>
  <section
    class="register-view flex-grow-1 d-flex align-items-center justify-content-center px-3 py-5"
  >
    <div class="card register-card border-0 shadow-lg w-100">
      <div class="card-body p-4 p-md-5">
        <div class="text-center mb-4">
          <span class="brand-mark d-inline-block fw-bold mb-3">YaListo</span>
          <h1 class="h2 fw-bold text-dark mb-2">Crear una cuenta</h1>
        ...
        <div class="text-center mt-4 pt-2">
          ...
          <router-link to="/login" class="login-link text-decoration-none fw-semibold">
            Inicia sesion
          </router-link>
        </div>
      </div>
